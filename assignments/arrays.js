...
const object33 = inventory[33];
// console.log(inventory[33]);
console.log(`Car 33 is a ${Object.values(object33)[3]} ${Object.values(object33)[1]}  ${Object.values(object33)[2]} `);
...
//   let carModels = [];
//   for (i=0;i<array.length;i++){
//     callbackResult = cb(array[i], i, array);
//     carModels.push(callbackResult)
